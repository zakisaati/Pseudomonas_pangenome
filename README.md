...
This repository contains the codes used for generating the data contained in the article "Comparative genomics of the genus Pseudomonas reveals host- and environment-specific evolution" (Saati-Santamaría, Z., Baroncelli, R., Rivas, R., García-Fraile, P.).
